...
```text
โจทยให้รับค่ามา 3 ค่า คือ จำนวนคน จำนวนคนที่ผลัดส่งกล่องของขวัญ และตำแหน่งคนที่โขมย โดยโจทย์ต้องการจำนวนของคนที่ได้รับพิจจารณาของขวัญตั้งแต่ครั้งแรกจนถึงครั้งสุดท้าย ผ่านการส่งของขวัญจำลองตามรูปแบบเข็มนาฬิกา
```
...
```text
1: รับ input  3 ค่าพร้อมกัน 
2: ให้ตรวจว่า gift == t หรือ gift == 1 หรือไม่
3: ถ้า ตรงกับเงื่อนไขให้หยุด
4:print จำนวนนับที่รวมได้จากแต่ละรอบ
```
...
```text
วิธีสุดท้ายคือเหมือนตอนแรกแต่ปรับให้ ถ้า t = 1 ให้ print จำนวนนับออกมาเลย
```
