...
```text
ให้รับ Input เป็นตัวเลขที่ตรงกับ เดือนตามที่โจทย์กำหนด โดยเมื่อ ตั้งแต่วันที่ 21 ของเดือนที่ 3 หารลงตัว จะเปลี่ยนฤดูกาลเป็นอันถัดไป
```
...
```text
ใช้ if else กับเดือนทั้งหมด และ นำ เดือนไปหาร 3 เพื่อดูว่า ตรงกับเงื่อนไขรึปล่าวซึ่งถ้าตรงก็ให้เพิ่มเดือนเพื่อให้เป็นเดือนถัดไป
```
...
```text
นำ 3 หารเดือนก่อน แล้วค่อยไปหาเดือน เพื่อความอ่านโค้ดง่ายขึ้น
```
...
```text
เพื่อดูว่าฤดูกาลจะกลับเป็นต้นเดือนรึปล่าว
```
