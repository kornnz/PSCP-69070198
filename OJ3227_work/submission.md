...
```text
โจทย์ให้เรา input แต้มกลุ่มของไพ่โดยจะเป็นตัวอักษร 1 ตัว คือ A หรือ J หรือ Q หรือ K หรือจำนวนเต็ม 1 จำนวนตั้งแต่ 2 - 10 แล้วตามด้วยตัวอักษร 1 ตัว คือ D หรือ H หรือ S หรือ C โดยตัวอักษรภาษาอังกฤษนั้นสามารถรับได้ทั้งพิมพ์ใหญ่พิมพ์เล็ก และให้ output แสดงออกมาเป็นไพ่ที่ตัวอักษรเหมือนกันจากตัวอักษรตัวแรก
```
...
```text
แผนแรกคือ ให้สร้าง list ขึ้นมาสองอัน อันแรกเป็นชื่อไพ่ อันที่สองเป็นตัวอักษรแรกของไพ่ โดยให้ for loop หาตัวอักษาที่เหมือนกับตัวแรก และตัวสุดท้ายของไพ่ แล้วนำมาเทียบ index กับ list ไพ่ ซึ่งทำเหมือนกันทั้งหน้าและหลัง
```
...
```text
วิธีสุดท้ายคือไม่ใช้ loop แต่นำตัวอักษรมาเทียบเลย ซึ่งตัวแรกถ้าเทียบไม่ได้แสดงว่ามันคือตัวเลข ส่วนตัวสุดท้ายมันเทียบได้อยู่แล้ว และก็ print ตามนั้น
```
...
```text
จะได้ลองว่าถ้าสองตัวเป็นเลข 10 จะprint ออกมาเป็นยังไง
```
