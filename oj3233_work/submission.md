...
```text
โจทย์ให้เราจำลองสลากกิแบ่งโดย input สองบบรทัด ซึ่งบรรทัดที่สองจะต้องตรงตามกฏที่ตั้งไว้กับ บรรทัดแรก แล้วจะ outputออกมาเป็นจำนวนเงินที่ได้
```
...
```text
1:รับ input 2 บรรทัด
2: ใช้ if else
3:print จำนวนเงินออกมา
```
...
```text
ถ้าทุกอย่างเหมือนกันจะแสดงออกมาเป็นยังไง
```
...
```text
ถ้าไม่ตรงเงื่อนไขจะออกมาเป็นยังไง
```
...
```text
ถ้าตัวเลขตรงอย่างงเดียวผลจะออกมาเป็นยังไง
```
