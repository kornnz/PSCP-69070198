...
```text
ให้ input จำนวน 2 จำนวน โดยตัวที่หนึ่งจะต้อง บวกตัวเองที่ถูกลบสอง ทุกรอบจนกว่าจะถึงค่าที่ input ค่าที่สอง โดยจะ output เป็นจำนวนครั้งที่ต้องบวก
```
...
```text
นำมา while loop บวกกันจนกว่าค่าแรก จะ มากกว่าเท่ากับ จัวนวนที่สอง
```
...
```text
ทำเหมือนเดิมแต่แก้โค้ดให้อ่านง่ายขึ้น
```
...
```text
จะดูว่าถ้าไม่สามารถบวกถึงผลจะออกเป็นยังไง
```
...
```text
ดูว่าสามารถใช้งานได้ปกติหรือไม่
```
