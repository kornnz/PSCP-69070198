...
```text
โจทย์ให้นำสีมาผสมกันโดยมีแค่สีแดง เหลือง และ น้ำเงิน

Input:
โจทย์รับค่า 2 บรรทัด เป็นชื่อสี 

Output:
คำตอบเป็น 1 บรรทัด เป็นชื่อสีที่ผสมออกมา หรือถ้าไม่ตรงตามเงื่อนไขให้แสดงเป็น Error

Constraints:
 input ได้แค่สีแดง เหลือง น้ำเงิน และสีที่เหมือนกัน นอกนั้น error
...
```text
1: รับ input 2 ค่า( 2 สี )
2: นำไปเทียบกันโดยใช้ if else
3: ถ้าสีตรงตามเงื่อนไขให้ print สี ออกมา
4: ถ้าไม่ตรงให้ print Error
...
```text
เหมือนวิธีที่คิดไว้ในตอนแรก แค่ปรับฟังชั้นให้ดูดีและอ่านง่ายขึ้น
```
...
```text
เพื่อเช็คว่าค่าที่จะออกมาตรงตามเงื่อนไขรึปล่าว
```
...
```text
เพื่อทดสอบฟังชั่นที่เขียนมาว่าจะทำงานรึป่าว
```
...
```text
ทดสอบเงื่อนไขที่ถ้าหากไม่ตรงข้อใดเลยจะตอบว่าอะไร
```
